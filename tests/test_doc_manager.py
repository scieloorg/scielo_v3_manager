...
class RegisterArticlesTest(TestCase):
    ...
    def test_register_article_which_article_is_not_registered_in_table_docs_but_it_is_in_pid_versions(
            self,
            mock__get_unique_v3,
            mock_is_registered_v3,
            mock__save_record,
        ...
        """
        Test registration of document which article is not registered in
            table docs, but it is in table pid_versions
        ...
        mock__get_document_from_pid_versions_table.return_value = {
            "v3": "recovered_from_pid_versions",
            "v3_origin": "recovered_from_pid_versions",
        }
        mock__get_document_from_pids_table.return_value = None
        mock__get_document_aop_version.return_value = None
        ...
        doc_data['issn'] = doc_data['v2'][1:10]
        doc_data['v3'] = "recovered_from_pid_versions"
        doc_data['v3_origin'] = "recovered_from_pid_versions"
        mock__save_record.assert_called_once_with(doc_data)

        self.assertIsNotNone(result["created"])

    def test_register_article_which_article_is_not_registered_in_table_docs_but_it_is_in_pids(
            self,
            mock__get_unique_v3,
            mock_is_registered_v3,
            mock__save_record,
        ...
        """
        Test registration of document which article is not registered in
            table docs, but it is in table pids
        ...
        mock__get_document_from_pids_table.return_value = {
            "v3": "recovered_from_pids",
            "v3_origin": "recovered_from_pids",
        }
        mock__get_document_aop_version.return_value = None
        ...
        doc_data['issn'] = doc_data['v2'][1:10]
        doc_data['v3'] = "recovered_from_pids"
        doc_data['v3_origin'] = "recovered_from_pids"
        mock__save_record.assert_called_once_with(doc_data)
